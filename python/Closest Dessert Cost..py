...
for base in baseCosts:
    # Loop over topping 0 units: 0, 1, 2
    for t0 in (0, 1, 2):
        # Loop over topping 1 units: 0, 1, 2
        for t1 in (0, 1, 2):
            # Loop over topping 2 units: 0, 1, 2
            for t2 in (0, 1, 2):
                total = base + t0 * toppingCosts[0] + t1 * toppingCosts[1] + t2 * toppingCosts[2]
...
print("Closest total cost:", best_total)
